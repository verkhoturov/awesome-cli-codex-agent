...
В интерактивном TTY клиент использует React Ink и сохраняет завершённые сообщения
в обычном terminal scrollback. При перенаправлении stdin или stdout автоматически
используется текстовый fallback без Ink и raw mode.
